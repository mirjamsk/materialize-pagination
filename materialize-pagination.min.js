/* materialize Pagination v0.2.1 | http://mirjamsk.github.io/materialize-pagination */
...
!1;this.$elem.removeClass("hide")},hide:function(){this.isHidden=!0;this.$elem.addClass("hide")}}}}};d.defaults=d.prototype.defaults;c.fn.materializePagination=function(a){return this.each(function(){(new d(this,a)).init()})}})(jQuery,window,document);