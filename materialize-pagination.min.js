...
parseUrl:function(){var a=this.getUrlParamByName(this.config.urlParameter)||1;return this.sanitizePageRequest(a)},getUrlParamByName:function(a){a=a.replace(/[\[\]]/g,"\\$&");return(a=(new RegExp("[?&]"+a+"(=([^&#]*)|&|#|$)")).exec(e.location.href))?a[2]?decodeURIComponent(a[2].replace(/\+/g," ")):"":null},util:{createPage:function(a){return c("<li>").text(a).addClass("waves-effect").attr("data-page",a)},createChevron:function(a){var b="next"===a?"right":"left",b=c("<i>").addClass("waves-effect").addClass("material-icons").text("chevron_"+
b);return this.createPage(a).text("").attr("data-page",a).append(b)},Ellipsis:function(){var a=c("<li>");a.text("...");a.addClass("hide");return{$elem:a,isHidden:!0,show:function(){this.isHidden=!1;this.$elem.removeClass("hide")},hide:function(){this.isHidden=!0;this.$elem.addClass("hide")}}}}};d.defaults=d.prototype.defaults;c.fn.materializePagination=function(a){return this.each(function(){(new d(this,a)).init()})}})(jQuery,window,document);